...
public partial class images_Register : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        string command = "insert into users values('" + rollnum.Value + "','" + firstname.Value + "','" + lastname.Value + "','" + mobile.Value + "','" + email.Value + "','" + DropDownList4.SelectedValue + "','" + birthdate.Value + "','" + DropDownList1.SelectedValue + "','" + DropDownList2.SelectedValue + "','" + RadioButtonList1.SelectedValue + "','"+pass.Value+"')";
